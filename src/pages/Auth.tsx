  ...
  return (
    <div className="min-h-[100dvh] bg-primary flex flex-col items-center justify-center px-6 max-w-md mx-auto">
      <div className="w-full space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-white border-white/80 text-foreground placeholder:text-foreground/40 focus-visible:ring-primary-foreground/50 shadow-sm"
              required
            />
          </div>
          <div className="relative">
        ...
        <Button variant="outline" className="w-full gap-2 bg-white border-white/80 text-foreground hover:bg-white/90 shadow-sm" onClick={handleGoogleLogin}>
